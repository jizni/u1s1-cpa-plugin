...
const (
	...
	// (u1s1-cli 1.11.5). The gateway's integrity check tells users to "升级并重新
	// 登录 u1s1", so this must track real CLI releases.
	defaultClientVersion = "1.11.5"
	...
	return registration{
		...
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				...
				{Name: "client-version", Type: pluginapi.ConfigFieldTypeString, Description: "Value of the x-u1s1-version header (default 1.11.5)."},
